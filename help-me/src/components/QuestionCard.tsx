...
export default function QuestionCard({question}: {question: Question}) {
    ...
    return(
        <div className="w-[90vw] max-w-[800px] bg-accent-50 border border-text-200  rounded-xl p-3
        ...
        >
            ...
            <Link to={`/questions/${question.id}`} className="text-sm text-accent-700 underline mt-1">
                See more
            </Link>
